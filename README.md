...
* [MessageBuilder](https://github.com/zepp-health/zeppos-samples/blob/main/application/2.0/todo-list/shared/message.js) ⭐ 222 | 🐛 20 | 🌐 JavaScript | 📅 2026-01-13 - Communication library based on Bluetooth. It sends message between Zepp OS device and Zepp App. And it includes [side service part](https://github.com/zepp-health/zeppos-samples/blob/main/application/2.0/todo-list/shared/message-side.js) ⭐ 222 | 🐛 20 | 🌐 JavaScript | 📅 2026-01-13.
...
* [zeppos-timer](https://github.com/XiaomaiTX/zeppos-timer) ⭐ 4 | 🐛 1 | 🌐 JavaScript | 📅 2023-05-23 - An accurate timer for ZeppOS.

### Tool

* [zepp-ts](https://github.com/tytydraco/zepp-ts) ⭐ 9 | 🐛 0 | 🌐 Shell | 📅 2022-12-09 - Build tool that use typescript to develop zeppos-app.

## App

### Infomation

* [BTC-ZeppOS-for-Watch](https://github.com/fwz233/BTC-ZeppOS-for-Watch) ⭐ 14 | 🐛 0 | 🌐 JavaScript | 📅 2022-06-17 - Check btc price at the moment on a watch running Zepp OS.
* [Anynews](https://github.com/fwz233/Anynews) ⭐ 6 | 🐛 3 | 🌐 JavaScript | 📅 2023-06-06 - Use Fetch api view any news.
* [zhihu](https://github.com/fwz233/zhihu) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2022-10-13 - See the hot list of Zhihu on the zeppos device.

### Social Media

* [FediClient](https://github.com/griffi-gh/zepp-fediclient) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2024-07-31 - Open-source Mastodon client for ZeppOS.
...
* [color-switch](https://github.com/sirAvent/color-switch) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2022-09-08 - Color Switch, an game developed on ZeppOS.
* [zepp-pong](https://github.com/Berezza98/zepp-pong) ⭐ 2 | 🐛 2 | 🌐 JavaScript | 📅 2022-10-15 - Zepp Pong is a beautiful and interesting game for Zepp OS.
* [Zepp-CircleWars](https://github.com/Berezza98/Zepp-CircleWars) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2022-09-13 - A Zepp OS game.
